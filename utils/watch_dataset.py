...
def load_data(pre_or_post):
    ...
    return (DataLoader(WatchDataset(train_acc_gyr_data, train_label_data), batch_size, shuffle=shuffle, num_workers=num_workers),
            DataLoader(WatchDataset(test_acc_gyr_data, test_label_data), batch_size, shuffle=shuffle, num_workers=num_workers))